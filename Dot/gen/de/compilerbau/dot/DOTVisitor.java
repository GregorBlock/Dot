...
public interface DOTVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link DOTParser#merge}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMerge(@NotNull DOTParser.MergeContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link DOTParser#arraydecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArraydecl(@NotNull DOTParser.ArraydeclContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link DOTParser#print}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrint(@NotNull DOTParser.PrintContext ctx);
